        ...
        <section className="mb-36">
            ...
            <div className="mx-4">
                ...
                <div className="flex w-full">
                    <div className="flex items-center flex-grow px-2 mr-2 rounded-sm shadow">
                        <input type="text" className="w-full h-full outline-none" placeholder="Enter your printing requirements" />
